...
void protobuf_AssignDesc_echo_2eproto() {
  ...
  static const int EchoRequest_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EchoRequest, res_msg_),
  };
  ...
  static const int EchoResponse_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EchoResponse, resp_msg_),
  };
...
#ifndef _MSC_VER
const int EchoRequest::kResMsgFieldNumber;
#endif  // !_MSC_VER
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_res_msg()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->res_msg().data(), this->res_msg().length(),
...
void EchoRequest::Swap(EchoRequest* other) {
  if (other != this) {
    std::swap(res_msg_, other->res_msg_);
...
#ifndef _MSC_VER
const int EchoResponse::kRespMsgFieldNumber;
#endif  // !_MSC_VER
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_resp_msg()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->resp_msg().data(), this->resp_msg().length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
...
void EchoResponse::MergeFrom(const EchoResponse& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_resp_msg()) {
      set_resp_msg(from.resp_msg());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void EchoResponse::Swap(EchoResponse* other) {
  if (other != this) {
    std::swap(resp_msg_, other->resp_msg_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
